...
namespace DesignPattern
{
    class Program
    {
        ...
        static void BuilderMode()
        {
            Form1 form1 = new Form1();
            form1.ShowDialog();
        }
        static void ObserverMode()
        {
            Boss lgs = new Boss();
        ...
        static void AbstractFactoryMode()
        {
            User user = new User
            {
                Name = "AAA",
        ...
        static void ConcreteMediatorMode()
        {
